...
public class GetUserByIdHandlerTests
{
    ...
    private readonly Mock<ICustomLogger<GetUserByIdHandler>> _loggerMock;
    ...
    public GetUserByIdHandlerTests()
    {
        ...
        _loggerMock = new Mock<ICustomLogger<GetUserByIdHandler>>();
    ...
    [Fact]
    public async Task Handle_ExistingUser_ReturnsEnrichedDto()
    {
        // Arrange
        ...
        var expectedDto = new UserEnrichedDto();
        _mapperMock.Setup(m => m.Map<UserEnrichedDto>(user)).Returns(expectedDto);
